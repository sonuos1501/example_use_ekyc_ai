...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  MaskView maskView = MaskView(10, 10, 200, 100);

  ValidationStep currentStep = ValidationStep.CARDBACK;
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) async {
      if (mounted) {
        ...
        OnCardValidationCallback onCardValidationCallback =
            OnCardValidationCallback();

        CardValidation cardValidation = CardValidation(
          sdkConfig,
          onCardValidationCallback,
        );

        cardValidation.detectImage(
...
class OnCardValidationCallback extends CardValidationCallBack {
  @override
  void takePicture(
